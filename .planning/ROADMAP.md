...
Plans:
- [x] 20-01-PLAN.md — Core data types (RobotModel, RobotSolver) + CMake infrastructure (INTERFACE test_models)
- [x] 20-02-PLAN.md — Model factory functions: 7 simple-domain chains (spatial_vectors through spatial_utils)
- [x] 20-03-PLAN.md — Model factory functions: 4 dynamics-domain chains (inverse_dynamics, forward_dynamics, consistency, spatial_operations)
- [x] 20-04-PLAN.md — SpatialAlgebra adapter (PIMPL) + compile_smoke_test zero-dependency verification
